...
public class DeterminationProjectile {

    private final Player owner;
    private boolean valid = false;
    private Fireball fireball;

    public DeterminationProjectile(Location location, Player owner) {
        this.owner = owner;
    }
    ...
    private void startParticleTrail(Fireball fireball) {
        Bukkit.getScheduler().runTaskTimer(Plugin.getPlugin(Plugin.class), new Runnable() {
            ...
            public void run() {
                ...
                fireball.getWorld().spawnParticle(Particle.DUST, fireball.getLocation(), 30, new Particle.DustOptions(Color.BLACK, 1));
            }
