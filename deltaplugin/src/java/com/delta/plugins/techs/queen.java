...
public class queen {
    ...
    static Technique bless = new Technique("bless", "Blessing of the Queen", false, cooldownHelper.minutesToMiliseconds(5), (player, item, args) -> {
    ...
    static Technique protonBlastTriple = new Technique("protonblast_triple", "Trident Hell Blast", false, cooldownHelper.minutesToMiliseconds(4), (player, item, args) -> {
    ...
    static Technique laugh = new Technique("lol", "The Queen's way", false, cooldownHelper.hour, (player, fruit, code) -> {
